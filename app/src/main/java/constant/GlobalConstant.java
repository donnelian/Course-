...
public class GlobalConstant {
    ...
    public static final String INDEX_URL = "http://jwc.scnu.edu.cn";// 华师教务系统首页
    public static final String SECRETCODE_URL = "http://jwc.scnu.edu.cn/CheckCode.aspx";// 验证码页面
    public static final String LOGIN_URL = "http://jwc.scnu.edu.cn/default2.aspx";// 华师教务系统登录页
    public static final String MAIN_URL = "http://jwc.scnu.edu.cn/xs_main.aspx?xh=";// 华师教务系统主页，菜单页面
    public static final String QUERY_STU_COURSE_URL = "http://jwc.scnu.edu.cn/xskbcx.aspx?xh=";// 华师查询个人课表链接
    public static final String QUERY_STU_COURSE_GNMKDM = "&gnmkdm=N121603";// 华师查询个人课表gnmkdm
    public static final String QUERY_STU_GRADE_URL = "http://jwc.scnu.edu.cn/xscjcx.aspx?xh=";// 华师查询个人成绩链接
    public static final String QUERY_STU_GRADE_GNMKDM = "&gnmkdm=N121605";// 华师查询个人成绩gnmkdm
    public static final String IDENTITY_STU = "学生";// 身份：学生
    public static final String SHIPAIXIAOQU = "1";// 华师石牌校区标志
    public static final String MEGAXIAOQU = "2";// 大学城校区标志
    public static final String NANHAIXIAOQU = "3";// 南海校区标志
